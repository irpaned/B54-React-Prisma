    ...
    <>
      <Box bg="black" w="400px" h="100%" color="white" p="20px 0 0 150px" m={0}>
        ...
        <Box mt="5">
          <Flex sx={CssDivFlex}>
            <HStack>
              <Link href="https://b54-stage2-online-xi.vercel.app/">
                <Icon sx={IconCss} as={BiSolidHomeSmile} />
              </Link>
              <Link
                href="https://b54-stage2-online-xi.vercel.app/"
                style={{ fontSize: 20 }}
                sx={LinkCss}
              >
                Home
          ...
          <Flex sx={CssDivFlex}>
            <HStack>
              <a href="https://b54-stage2-online-xi.vercel.app/search">
                <Icon sx={IconCss} as={IoSearch} />
              </a>
              <a
                href="https://b54-stage2-online-xi.vercel.app/search"
                style={{ fontSize: 20 }}
              >
                Search
              </a>
          ...
          <Flex sx={CssDivFlex}>
            <HStack>
              <Link href="https://b54-stage2-online-xi.vercel.app/profile">
                <Icon sx={IconCss} as={CgProfile} />
              </Link>
              <Link
                href="https://b54-stage2-online-xi.vercel.app/profile"
                style={{ fontSize: 20 }}
                sx={LinkCss}
              >
                Profile
